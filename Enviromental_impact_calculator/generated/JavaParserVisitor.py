...
class JavaParserVisitor(ParseTreeVisitor):
    ...
    def visitModularCompulationUnit(self, ctx:JavaParser.ModularCompulationUnitContext):
        return self.visitChildren(ctx)
    ...
    def visitAnnotationFieldValues(self, ctx:JavaParser.AnnotationFieldValuesContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#annotationFieldValue.
    def visitAnnotationFieldValue(self, ctx:JavaParser.AnnotationFieldValueContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#annotationValue.
    def visitAnnotationValue(self, ctx:JavaParser.AnnotationValueContext):
        return self.visitChildren(ctx)
    ...
    def visitComponentPatternList(self, ctx:JavaParser.ComponentPatternListContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#componentPattern.
    def visitComponentPattern(self, ctx:JavaParser.ComponentPatternContext):
        return self.visitChildren(ctx)
    ...
    def visitGuard(self, ctx:JavaParser.GuardContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by JavaParser#casePattern.
    def visitCasePattern(self, ctx:JavaParser.CasePatternContext):
        return self.visitChildren(ctx)
